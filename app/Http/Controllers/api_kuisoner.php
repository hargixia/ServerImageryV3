    ...
    public function kuisoner_jawab($data){
        ...
        if($data[0] == "kj"){
            ...
            for($i=4;$i<$c_data;$i++){
                ...
                $cnilai = (int)$temp[1];
                if($temp_tipe->tipe == 'N'){
                    $cnilai = ($cApps->jumlah_pertanyaan) - $cnilai;
                }
            ...
            array_push($res,[
                ...
                'rekomendasi'   => $rekomen,
                'kategori'      => $kat,
                'tanggal'       => date('d-m-Y',strtotime($kuisoner->created_at)),
                'hari'          => $dayMapping[date('l', strtotime($kuisoner->created_at))]
            ]);
